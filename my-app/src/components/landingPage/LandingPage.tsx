  ...
  return (
    <div className=''>
      <header className='flex justify-evenly border-gray-100 border-b-2'>
        ...
        <div>
          <button className='m-2 bg-white hover:bg-gray-300 text-blue-500 font-bold px-4 border-b-4 border-gray-300 hover:border-gray-100 rounded'>Login</button>
          <button className='m-2 bg-blue-500 hover:bg-blue-400 text-white font-bold px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded'>Register</button>
        </div>
      </header>

      <main className='flex justify-evenly w-9/12 m-auto'>
        <img className='h-fit' src={hero} alt="hero" />
